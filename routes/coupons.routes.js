...
router.route("/create-one-coupons").post(upload().none(), createCoupon);
...
router.route("/edit-one-coupons/:id").put(upload().none(), editCoupon);
router.route("/delete-one-coupons").delete(upload().none(), deleteCoupon);
